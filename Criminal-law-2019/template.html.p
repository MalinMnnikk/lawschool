...
<head>
  ...
  <style type="text/css">
    ...
    h1 {background: #F4EBFF; color: #473E61; display: inline; padding: 10px;}
...
◊when/splice[prev-page]{
 <span id="prev">←
 <a href="/lawschool/◊|prev-page|">◊(select 'h1 prev-page)</a>
 </span>}
◊(define next-page (next here))
◊when/splice[next-page]{
 <span id="next"><a href="/lawschool/◊|next-page|">◊(select 'h1 next-page)</a> →
 </span>}
</body>
</html>